...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaHVuZzI1MDMiLCJhIjoiY2t6emRtNGYxMDk3azNkcWNlNW5ndDR3YSJ9.dYjrQiWK1gEFgohEM35XPg';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toLowerCase(), " update success")); // location.reload(true) 
            }
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KYSCuDkmaL7GnZZPqsOgnTImn5BKAHx88XYS9t5tiWeIUkuKzGqyogl0zg8VzHxtKmZVvWCqffb4GPxfydp06PV00HAVvUcT2');
            _context.prev = 1;
            _context.next = 4;
